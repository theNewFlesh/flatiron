...
class FitConfig(scm.Model):
    batch_size=None, serialize_when_none=True)
    epochs=scmt.IntType(1,
    verbose='auto',
    validation_split=0.0,
    shuffle=True,
    class_weight=None, serialize_when_none=True)
    sample_weight=None, serialize_when_none=True)
    initial_epoch=scmt.IntType(0,
    validation_steps=None, serialize_when_none=True)
    validation_batch_size=None, serialize_when_none=True)
    validation_freq=scmt.IntType(1,
    max_queue_size=scmt.IntType(10,
    workers=1,
